...
public class SongList {
    public static ArrayList<Song> getSongs(){
        Song song1 = new Song(1,"Emotion Engine","dazegxd", "vKiss",250,"album_cover","emotion_engine");
        Song song2 = new Song(2,"Crescendolls","Daft Punk", "Discovery",250,"album_cover","crescendolls");
        Song song3 = new Song(3,"Emotion Engine","dazegxd", "vKiss",250,"album_cover","emotion_engine");
        Song song4 = new Song(4,"Crescendolls","Daft Punk", "Discovery",250,"album_cover","crescendolls");
        Song song5 = new Song(4,"Crescendolls","Daft Punk", "Discovery",250,"album_cover","crescendolls");
        Song song6 = new Song(4,"Crescendolls","Daft Punk", "Discovery",250,"album_cover","crescendolls");
        Song song7 = new Song(4,"Crescendolls","Daft Punk", "Discovery",250,"album_cover","crescendolls");
        Song song8 = new Song(4,"Crescendolls","Daft Punk", "Discovery",250,"album_cover","crescendolls");
        Song song9 = new Song(4,"Crescendolls","Daft Punk", "Discovery",250,"album_cover","crescendolls");
